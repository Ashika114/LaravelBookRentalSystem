...
<section class="vh-500" style="background-color:#fef8f5;">
  <div class="container py-0 h-100">
    <div class="row d-flex align-items-center justify-content-center h-100">
      ...
      <input type="hidden" value="{{$register['regid']}}" name="txtid" />
          <!-- Username input -->
          <div class="form-outline mb-4">
            <input type="text" id="username" name="txtusername" placeholder="Enter username" value="{{$register['username']}}" class="form-control form-control-lg"  />
            <label class="form-label" for="username">Username</label>
          </div>
        
          <!-- Password input -->
          <div class="form-outline mb-4">
            <input type="password" id="form1Example23" value="{{$register['password']}}" name="txtpassword" class="form-control form-control-lg" />
