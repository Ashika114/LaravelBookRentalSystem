...
<table class="table table-bordered" style="background-color: white">
    ...
    <?php $__currentLoopData = $booking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       ...
       <th scope="row"><?php echo e($b['bookingid']); ?></th>
        ...
        <td><?php echo e($b['days']); ?></td>
        <td><?php echo e($b['status']); ?></td>
        <td><?php echo e($b['confirmation']); ?></td>
        <td><a href="/readerbkcancel/<?php echo e($b['bookingid']); ?>">CANCEL</td>
        </tr>
...
<?php echo $__env->make('reader/readerlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MCA_PROJECT\book\resources\views/reader\readerbookingshow.blade.php ENDPATH**/ ?>