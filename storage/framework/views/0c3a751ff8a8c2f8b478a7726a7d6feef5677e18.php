...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="/readerhome1">Home</a></li>
          <li><a class="nav-link scrollto" href="/readerbookshowController">Booking</a></li>
          <li><a class="nav-link scrollto" href="/readerpro">Profile</a></li>
          <li><a class="nav-link scrollto" href="/readerbookingshow">BookingShow</a></li>
          <li><a class="nav-link scrollto" href="/readerbookreturn">BookReturn</a></li>
          <li><a class="nav-link scrollto" href="/readerbookingcancelshow">BookingCancel</a></li>
          <li><a class="nav-link scrollto" href="/logout">Logout</a></li>
          <li><a class="nav-link scrollto" href=""> <div class="small">Logged in as:</div>
                    <?php echo e(session('username')); ?></a></li>
        </ul>
  ...
  <main id="main">
  <div class="container" style="background-color:#fef8f5;">
...
</html><?php /**PATH D:\MCA_PROJECT\book\resources\views/reader/readerlayout.blade.php ENDPATH**/ ?>