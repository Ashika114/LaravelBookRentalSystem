...
<section class="vh-500" style="background-color:#fef8f5;">
  <div class="container py-0 h-100">
    <div class="row d-flex align-items-center justify-content-center h-100">
     ...
     <center> <h2 class="fw-bold" style="margin-bottom:20px;"><?php echo e($title); ?></h2></center>
      <form action="<?php echo e($url); ?>" method="post">
      <?php echo csrf_field(); ?>

          <!-- Username input -->
          <div class="form-outline mb-4">
            <input type="text" id="username" name="txtusername" placeholder="Enter username" class="form-control form-control-lg"  />
