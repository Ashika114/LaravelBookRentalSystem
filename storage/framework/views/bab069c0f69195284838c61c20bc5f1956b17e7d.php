...
<?php $__currentLoopData = $book; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <div class="col-4" style="margin-top:10px;">
      ...
      <div class="card">
        ...
        <p><a href="/booking/<?php echo e($b['bookid']); ?>"><button style="color: white; background-color: #eb5d1e;">Booking</button></a></p>
        <p><a href="/bookdetails/<?php echo e($b['bookid']); ?>"> <button>Details</button></a></p>
...
<?php echo $__env->make('reader/readerlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MCA_PROJECT\book\resources\views/reader\readerbookshow.blade.php ENDPATH**/ ?>