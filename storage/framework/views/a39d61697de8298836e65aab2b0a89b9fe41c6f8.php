        ...
        <div class="card shadow-2-strong" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="row" id="row">
              ...
              <div class="col">
                <input type="email" class="form-control" id="pemail" name="email" placeholder="Enter EmailAddress">
              </div>
            </div>
...
<?php echo $__env->make('admin/adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MCA_PROJECT\book\resources\views/admin\publicationform.blade.php ENDPATH**/ ?>